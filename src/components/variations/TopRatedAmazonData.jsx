...
const TopRatedAmazonData =  ({title}) => {
    ...
    useEffect(()=>{
        ...
        const topRatedParam = "&rh=p_72%3A12407972031";
        var final_amazon_url = "https://cors-anywhere.herokuapp.com/https://www.amazon.ae/s?k="+keyword+topRatedParam;
...
export default TopRatedAmazonData;
